    ...
    <div className="container">
        ...
        <div className="desktop-table">
            ...
            <tbody>
                <tr>
                <td>Mon</td>
                <td><span className="subject">Prob & Stats</span><br /><span className="room">NR321</span></td>
                <td><span className="subject">Prob & Stats</span><br /><span className="room">NR321</span></td>
                <td></td>
                <td></td>
                <td><span className="subject">Algo</span><br /><span className="room">NC231</span></td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
                ...
                <td></td>
                <td></td>
                <td><span className="subject">AI</span><br /><span className="room">NC231</span></td>
                <td></td>
                <td><span className="subject">ML</span><br /><span className="room">NC231</span></td>
                <td><span className="subject">ML Lab</span><br /><span className="room">CIC Lab VI</span></td>
                <td><span className="subject">ML Lab</span><br /><span className="room">CIC Lab VI</span></td>
                <td><span className="subject">ML Lab</span><br /><span className="room">CIC Lab VI</span></td>
                <td></td>
                </tr>
                ...
                <td><span className="subject">ML</span><br /><span className="room">NC231</span></td>
                <td></td>
                <td><span className="subject">Algo lab</span><br /><span className="room">CIC Lab VI</span></td>
                <td><span className="subject">Algo lab</span><br /><span className="room">CIC Lab VI</span></td>
                <td><span className="subject">Algo lab</span><br /><span className="room">CIC Lab VI</span></td>
                <td></td>
                </tr>
                ...
                <td><span className="subject">AI</span><br /><span className="room">NC231</span></td>
                <td><span className="subject">AI</span><br /><span className="room">NC231</span></td>
                <td><span className="subject">Lin Alg</span><br /><span className="room">NC234</span></td>
                <td><span className="subject">Lin Alg</span><br /><span className="room">NC234</span></td>
                <td><span className="subject">Lin Alg</span><br /><span className="room">NC234</span></td>
                <td><span className="subject">Lin Alg</span><br /><span className="room">NC234</span></td>
                </tr>
